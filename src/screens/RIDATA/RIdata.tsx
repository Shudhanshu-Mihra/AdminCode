...
import { IRecieptInvoiceData } from './types/RIdata.type'; // Import the correct type
...
export const RIdata = () => {
  ...
  const derivedIsEmptyData = recieptInvoiceData.length === 0;
    ...
    <>
      ...
      <Styled.TableWrapper>
				...
				<TableInboxAdmin
					...
					receiptList={recieptInvoiceData}
